...
void GameServer::init(){
    ...
    /**
     * Send the requesting player the data that is prepared for him in his send buffer
     */
    ...
    /** 
     * Receive a single choice from the player and store it in his choice buffer
     */ 
    ...
    /**
     * Receive multiple choices from the player and store them in his choice buffer vector
     */
